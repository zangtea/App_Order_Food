package com.example.app_order_food.Adapter;
...
import com.example.app_order_food.Activity.ListFoodsActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewholder holder, @SuppressLint("RecyclerView") int position) {
     ...
     int drawabResourceId = context.getResources().getIdentifier(items.get(position).getImagePath(),"drawable",holder.itemView.getContext().getPackageName());
